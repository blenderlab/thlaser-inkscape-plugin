...
def draw_svg_rect(x,y,w,h, parent):
    rect_attribs = {'style':simplestyle.formatStyle({ 'stroke': 'none', 'stroke-width':'1', 'fill':'red', 'fill-opacity':'0.1'}), 'x':str(x), 'y':str(y), 'width':str(w), 'height':str(h)}
...
class Gcode_tools(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("-p", "--feed",                    action="store", type="float",         dest="feed", default="1000",                        help="Cutting feed rate in unit/min")
        ...
        self.OptionParser.add_option("",   "--mirrory",action="store", type="inkbool",    dest="mirrory", default=False,help="set laser coord system zero to bottom left (like inkscape)")        
        self.OptionParser.add_option("",   "--dovector",action="store", type="inkbool",    dest="dovector", default=False,help="generate gcode for vector")        
        self.OptionParser.add_option("",   "--dobitmap",action="store", type="inkbool",    dest="dobitmap", default=False,help="generate gcode for bitmap")        
        self.OptionParser.add_option("",   "--invbitmap",action="store", type="inkbool",    dest="invbitmap", default=False,help="invert bitmap")        
        ...
        self.OptionParser.add_option("",   "--usespindle",                 action="store", type="inkbool",    dest="usespindle", default=False, help="Use M3/M5 for laser control")
        self.OptionParser.add_option("",   "--homing",                 action="store", type="inkbool",    dest="homing", default=False, help="Home XY on start")
        self.OptionParser.add_option("",   "--airfan",                 action="store", type="inkbool",    dest="airfan", default=False, help="Turn on fan while cutting")
    ...
    def effect_bitmap(self, selected):
        ...
        for id, node in self.selected.iteritems():
            if node.tag == inkex.addNS('image','svg'):         
                ...
                image = Image.open(tempimg).convert('L')
